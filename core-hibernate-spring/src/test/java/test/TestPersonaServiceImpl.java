...
//
	...
	@Test
	@Transactional
	public void TestoGenericService() {
		try {
			System.out.println();
			logger.info("Inicio del test TestoGenericService");
			logger.info("Inicio listado de personas");
			List<Rol> lstResult = rolService.listar();
			logger.info("Fin del test TestoGenericService");
			System.out.println();
		} catch (Exception e) {
...
//			Persona persona2 = personaService.recuperarPersona(new Persona((long) 1));
