...
@ContextConfiguration(locations = { "classpath:application-context.xml","classpath:mvc-dispatcher-servlet.xml","classpath:spring-security.xml","classpath:hdiv-config.xml" })
